...
import { MeshPhysicalNodeMaterial, color, cross, getRoughness, materialMetalness, materialRoughness, mix, modelNormalMatrix, normalLocal, normalWorld, positionLocal, roughness, sin, smoothstep, tangentLocal, timerGlobal, tslFn, uniform, varyingProperty, vec3, vec4 } from 'three/examples/jsm/nodes/Nodes.js'
